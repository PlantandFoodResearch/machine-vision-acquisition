...
class GenICamParam(BaseModel):
    ...
    val_type: Optional[Literal["str", "int", "float", "bool"]] = Field(description="Force type when setting, otherwise a guess will be attempted")
...
class Camera(BaseModel):
    ...
    serial: str
    params: Optional[List[GenICamParam]] = Field(description="GenICam parameters to this camera. Note: the order will attempt to be respected")
